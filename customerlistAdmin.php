...
<header>
  ...
  <nav>
    ...
    <div class="text-center">
      <button type="button" class="btn btn-info" href="customerlist.php" data-toggle="modal" data-target="#donate1">DONATE</button>
      <button type="button" class="btn btn-info" href="customerlist.php" data-toggle="modal" data-target="#transactionHistory">DONATION HISTORY</button>
	<button type="button" class="btn btn-info" href="customerlist.php" data-toggle="modal" data-target="#AddDonationlist">Add Donation List</button>
	<button type="button" class="btn btn-info" href="customerlist.php" data-toggle="modal" data-target="#AllUserList">All User List</button>
    </div>
  ...
  <section id="main" class="coloured-section">
    ...
    <!--Modal Send Money-->
    <div class="modal fade" id="donate1" tableindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Donate for all</h5>
          ...
          <div class="modal-body">
              ...
              <div class="input-group mb-3">
                <h3>Welcome <u><?php echo $_SESSION["username"];?></u>.</h3>
				<?php //<input type="text" id="enterSName" name="enterSName" class="form-control" placeholder="Sender's Username" name="SUser" aria-label="Sender's Username" aria-describedby="basic-addon2"> ?>
                <div class="input-group-append">
                  <span class="input-group-text" id="basic-addon2">@gmail.com</span>
                </div>
              </div>
              <div class="input-group mb-3">
                <?php //<input type="text" id="enterName" class="form-control" placeholder="Recipient's Username" aria-label="Recipient's Username" aria-describedby="basic-addon2">
                ?>
...
<div class="form-group col-md-4">
	  ...
	  <div class="input-group-append">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" id="enterAmount" name="enterAmount" class="form-control" placeholder="Enter Amount" aria-label="Amount">
                <div class="input-group-append">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
           	<button class="btn btn-primary" type="submit" name="savedata">savedata</button>
...
<!--Modal Add Donation List-->
    <div class="modal fade" id="AddDonationlist" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
		  ...
		  <div class="input-group mb-3">
                ...
                <input type="text" id="enterDonationName" name="DonationName" class="form-control" placeholder="Enter Donation Name" aria-label="Amount">
                <div class="input-group-append">
                  <span class="input-group-text"></span>
                </div>
              </div>
			   ...
			   <div class="input-group mb-3">
                ...
                <input type="text" id="enterDonationEmailId" name="DonationEmailId" class="form-control" placeholder="Enter Donation Email ID" aria-label="Amount">
                <div class="input-group-append">
                  <span class="input-group-text"></span>
                </div>
              </div>
          ...
          <div class="modal-footer">
            	<button class="btn btn-primary" type="submit" name="savedata2">savedata</button>
          </div>
		  </form>
        </div>
      </div>
 ...
 <!--Modal All User List-->
    <div class="modal fade" id="AllUserList" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">All User List</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
		...
		for($i=0;$i<=$rc-1;$i++)
		{
			$row=mysqli_fetch_array($FQ2);
			  ...
			  <td><?php echo $i;?></td>
			  <td><?php echo $row['user'];?></td>
			  <td><a href="deus.php?id=<?php echo $row['user']; ?>">Delete</a></td>
...
<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
  ...
  $(document).ready(function(){
	  $('#donate_f').on('donate',function(event){
		  event.prevntDefault();
		  if($('#enterSName').val()==" ")
		  {
			  alert("name is requiried");
		  }
	  }
  })
  </script>
